...
const breadcrumbs = [
  ...
  { title: 'Tambah Shift', href: '' },
];

export default function ShiftCreate({ companies, plants, isSuperAdmin }: any) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/manajemen/shift');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Shift Baru" />
            ...
            <div className="mt-6 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Tambah Shift Baru</h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Isi informasi lengkap shift kerja yang akan dibuat
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
