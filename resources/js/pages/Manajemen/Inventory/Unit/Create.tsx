...
export default function CreateUnit({ companies }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('inventory.unit.store'));
  };

  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Tambah Unit Inventory" />
      <div className="mt-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Tambah Unit Inventory</h1>
            <p className="text-gray-600 mt-1">Buat unit baru untuk satuan item inventory</p>
          </div>
          <Button
            variant="outline"
