...
const breadcrumbs = [
  ...
  { title: 'Tambah Status Karyawan', href: '' },
];

export default function StatusKaryawanCreate({ companies, plants, isSuperAdmin }: any) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/manajemen/status-karyawan');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Status Karyawan Baru" />
            ...
            <div className="mt-6 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Tambah Status Karyawan Baru</h1>
                        <p className="text-muted-foreground">
                            Buat status karyawan baru
                        </p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Isi informasi lengkap status karyawan yang akan dibuat
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
