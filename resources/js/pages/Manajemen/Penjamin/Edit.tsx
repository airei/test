...
const breadcrumbs = [
  ...
  { title: 'Edit Penjamin', href: '' },
];

export default function PenjaminEdit({ guarantor, companies, plants, isSuperAdmin }: any) {
    const { data, setData, put, processing, errors } = useForm({
        company_id: guarantor.company_id || '',
        plant_id: guarantor.plant_id || '',
        name: guarantor.name,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/manajemen/penjamin/${guarantor.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Penjamin - ${guarantor.name}`} />
            <div className="mt-6 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Edit Penjamin</h1>
                        <p className="text-muted-foreground">
                            Perbarui informasi penjamin "{guarantor.name}"
                        </p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Perbarui informasi penjamin asuransi
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
