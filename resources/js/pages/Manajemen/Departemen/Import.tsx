...
export default function Import({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (data.file) {
      post(route('departemen.import.store'), {
        forceFormData: true,
      });
    }
  };
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Import Departemen" />
      
      <div className="mt-6 space-y-6">
        {/* Header */}
        <div className="flex items-center space-x-4">
          <Link href={route('departemen.index')}>
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Import Departemen</h1>
            <p className="text-muted-foreground">
              Import data departemen dari file Excel
            </p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Pilih file Excel (.xlsx atau .xls) yang berisi data departemen
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="text-xs space-y-1 text-gray-600">
                      ...
                      <table className="min-w-max border text-xs">
                        <thead>
                          <tr className="bg-gray-100">
                            <th className="border px-2 py-1">nama_departemen</th>
                            <th className="border px-2 py-1">deskripsi</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="border px-2 py-1">Keuangan</td>
                            <td className="border px-2 py-1">Mengelola keuangan perusahaan</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    <ul className="list-disc list-inside space-y-1">
                      ...
                      <li>Nama departemen maksimal 255 karakter</li>
                ...
                <div>
                  ...
                  <ul className="text-xs space-y-1 text-gray-600">
                    <li>• Nama departemen wajib diisi dan harus unik per company/plant</li>
                ...
                <div className="pt-4 border-t">
                  <a
                    href={route('departemen.template')}
                    className="w-full"
                    download
                  >
